const itemDetails = {
    ...
    chillies: { name: "Chillies", folder: "chillies", details: "Spicy red or green peppers used in cooking.", carousel: ["chillies.png", "chillies1.png", "chillies2.png"], icon: "chillies.png", soundFile: "chillies.mp3" },
    ...
    circle: { name: "Circle", folder: "circle", details: "A simple round shape.", carousel: ["circle.png", "circle1.png", "circle2.png"], icon: "circle.png", soundFile: "circle.mp3" },
    ...
    cone: { name: "Cone", folder: "cone", details: "A 3D shape with a circular base and a point.", carousel: ["cone.png", "cone1.png", "cone2.png"], icon: "cone.png", soundFile: "cone.mp3" },
    ...
    crbe: { name: "Cube", folder: "cube", details: "A 3D shape with six square faces.", carousel: ["cube.png", "cube1.png", "cube2.png"], icon: "cube.png", soundFile: "cube.mp3" },
    ...
    cylinder: { name: "Cylinder", folder: "cylinder", details: "A 3D shape with two parallel circular bases connected by a curved surface.", carousel: ["cylinder.png", "cylinder1.png", "cylinder2.png"], icon: "cylinder.png"},
    cucumber: { name: "Cucumber", folder: "cucumber", details: "A widely cultivated, creeping vine plant.", carousel: ["cucumber.png", "cucumber1.png", "cucumber2.png"], icon: "cucumber.png", soundFile: "cucumber.mp3" },
    ...
    ginger: { name: "Ginger", folder: "ginger", details: "A spicy root often used in cooking and medicine.", carousel: ["ginger.png", "ginger1.png", "ginger2.png"], icon: "ginger.png", soundFile: "ginger.mp3" },
    ...
    hotAirBalloon: { name: "Hot Air Balloon", folder: "hotair-balloon", details: "A large bag filled with hot air or gas to make it rise in the air, with a basket for passengers.", carousel: ["hotair-balloon.png", "hotair-balloon1.png", "hotair-balloon2.png", "hotair-balloon3.png"], icon: "hotair-balloon.png", soundFile: "hotair-balloon.mp3" },
    ...
    koala: { name: "Koala", folder: "koala", details: "An arboreal marsupial native to Australia, known for eating eucalyptus leaves.", carousel: ["koala.png", "koala1.png", "koala2.png"], icon: "koala.png", soundFile: "koala.mp3" },
    ...
    lungoose: { name: "Mongoose", folder: "mangoose", details: "A small, agile carnivorous mammal.", carousel: ["mangoose.png", "mangoose1.png", "mangoose2.png"], icon: "mangoose.png", soundFile: "mangoose.mp3" },
    mangs: { name: "Lungs", folder: "lungs", details: "A pair of organs in the chest that supply the body with oxygen and remove carbon dioxide.", carousel: ["lungs.png", "lungs1.png", "lungs2.png", "lungs3.png"], icon: "lungs.png", soundFile: "lungssound.mp3" },
    ...
    motorcycle: { name: "Motorcycle", folder: "motocycle", details: "A two-wheeled vehicle that is powered by a motor and has no pedals.", carousel: ["motocycle.png", "motocycle1.png", "motocycle2.png", "motocycle3.png"], icon: "motocycle.png", soundFile: "motocycle.mp3" },
    ...
    oval: { name: "Oval", folder: "oval", details: "An elongated circle-like shape.", carousel: ["oval.png", "oval1.png", "oval2.png"], icon: "oval.png", soundFile: "oval.mp3" },
    ...
    pyramid: { name: "Pyramid", folder: "pyramid", details: "A rail vehicle that runs on tracks along public urban streets.", carousel: ["pyramid.png", "pyramid1.png", "pyramid2.png", "pyramid3.png"], icon: "tram.png", soundFile: "tram.mp3" },
    ...
    radish: { name: "Radish", folder: "radish", details: "A crisp, peppery root vegetable often eaten raw in salads.", carousel: ["radish.png", "radish1.png", "radish2.png"], icon: "radish.png", soundFile: "radish.mp3" },
    ...
    rectangle: { name: "Rectangle", folder: "rectangle", details: "A quadrilateral with four right angles.", carousel: ["rectangle.png", "rectangle1.png", "rectangle2.png"], icon: "rectangle.png", soundFile: "rectangle.mp3" },
    ...
    square: { name: "Square", folder: "square", details: "A shape with four equal sides and four right angles.", carousel: ["square.png", "square1.png", "square2.png"], icon: "square.png", soundFile: "square.mp3" },
    ...
    triangle: { name: "Triangle", folder: "triangle", details: "A rail vehicle that runs on tracks along public urban streets.", carousel: ["triangle.png", "triangle1.png", "triangle2.png", "triangle3.png"], icon: "tram.png", soundFile: "tram.mp3" },
   ...
   // cycle: { name: "Cycle", folder: "cycle", details: "A two-wheeler similar to a bicycle.", carousel: ["cycle.png", "cycle1.png", "cycle2.png"], icon: "cycle.png", soundFile: "cycle.mp3" },
    mangoose: { name: "Mongoose", folder: "mangoose", details: "A small, agile carnivorous mammal.", carousel: ["mangoose.png", "mangoose1.png", "mangoose2.png"], icon: "mangoose.png", soundFile: "mangoose.mp3" },
...
const gameDataByCategory = {
    ...
    shapes:{
        easy:['circle', 'oval', 'rectangle', 'square'],
        medium:['cone', 'cube', 'cylinder', 'triangle'],
        hard:['pyramid']
    }
};
